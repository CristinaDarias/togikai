...
export const fights: FightRecord[] = [
  {
    ...
    fighterB: 'Kage',
    winner: 'Empate',
    method: 'Empate técnico',
    pointsDelta: { winner: 0, loser: 0 },
    chronicle: 'Tras cinco asaltos de control y escapes, ni el suelo ni la distancia dieron ventaja clara. La mesa declaró empate.',
  },
  {
    id: 'TGI-090',
    date: '2026-04-29',
    ...
    winner: 'Gyuki',
    method: 'KO R2',
    pointsDelta: { winner: 31, loser: -21 },
    chronicle: 'Ryu abrió fuerte con low kicks, pero Gyuki cerró el ángulo y conectó una derecha al hígado que apagó la ofensiva.',
  },
  {
    id: 'TGI-089',
    date: '2026-04-28',
    ...
    pointsDelta: { winner: 29, loser: -20 },
    chronicle: 'Taraku impuso ritmo de codos y rodillas en corto; Amaterasu no encontró la lectura a tiempo.',
  },
  {
    id: 'TGI-088',
    date: '2026-04-27',
    ...
    winner: 'Konjou',
    method: 'TKO R3',
    pointsDelta: { winner: 27, loser: -18 },
    chronicle: 'Konjou castigó al cuerpo durante tres rounds hasta romper la respiración de Nobita y forzar la detención.',
  },
  {
    id: 'TGI-087',
    date: '2026-04-25',
    ...
    winner: 'Amaterasu',
    method: 'Sumisión R4',
    pointsDelta: { winner: 30, loser: -19 },
    chronicle: 'Kage quiso oscurecer el ritmo, pero Amaterasu lo atrapó en transición y cerró llave al brazo en el cuarto.',
  },
  {
    id: 'TGI-086',
    date: '2026-04-23',
    ...
    fighterB: 'Ryu',
    winner: 'Empate',
    method: 'Empate dividido',
    pointsDelta: { winner: 0, loser: 0 },
    chronicle: 'Una guerra de distancia media sin caída ni control sostenido. El veredicto terminó partido y en tablas.',
  },
  {
    id: 'TGI-085',
    date: '2026-04-21',
    ...
    fighterB: 'Konjou',
    winner: 'Gyuki',
    method: 'Decisión dividida',
    pointsDelta: { winner: 23, loser: -16 },
    chronicle: 'Gyuki ganó los intercambios cerrados, Konjou dominó volumen. La decisión cayó por mínima diferencia.',
  },
  {
    id: 'TGI-084',
    date: '2026-04-27',
    ...
    winner: 'Amaterasu',
    method: 'TKO R4',
    pointsDelta: { winner: 34, loser: -22 },
    chronicle: 'Bajo una lluvia de neón rojo, Amaterasu rompió la guardia en el cuarto asalto y cerró la noche con una secuencia limpia al mentón.',
  },
  {
    id: 'TGI-083',
    date: '2026-04-13',
    ...
    winner: 'Taraku',
    method: 'Decisión dividida',
    pointsDelta: { winner: 26, loser: -18 },
    chronicle: 'Taraku sobrevivió al castigo interno de Konjou y robó los dos últimos rounds con codos precisos en corta distancia.',
  },
  {
    id: 'TGI-082',
    date: '2026-03-29',
    ...
    winner: 'Kage',
    method: 'Sumisión R3',
    pointsDelta: { winner: 24, loser: -17 },
    chronicle: 'Kage desapareció del intercambio frontal, llevó la pelea al suelo y cerró un estrangulamiento en silencio total.',
  },
];
