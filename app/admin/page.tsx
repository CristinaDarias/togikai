      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <article className="panel rounded-md p-5">
          ...
          <div className="mt-4 grid gap-2 text-sm">
            ...
            <input value={fighterForm.imageUrl ?? ''} onChange={(e) => setFighterForm((p) => ({ ...p, imageUrl: e.target.value }))} placeholder="Nombre archivo imagen (ej: amaterasu.png)" className="rounded border border-zinc-700 bg-black/40 px-3 py-2" />
            <input value={fighterForm.imageHoverUrl ?? ''} onChange={(e) => setFighterForm((p) => ({ ...p, imageHoverUrl: e.target.value }))} placeholder="Nombre archivo hover (ej: amaterasu-hover.png)" className="rounded border border-zinc-700 bg-black/40 px-3 py-2" />
